...
This repository was developed as a course project for the **Explainable AI (XAI)** class of the [MVA Master's program](https://www.master-mva.com/) (ENS Paris-Saclay, 2025–2026). Report available [here](https://drive.google.com/file/d/1NWlgrKGaIs9sSahoeDzQQJXadhdwMCOk/view?usp=sharing).
